            ...
            <Formik
                ...
                {({ handleChange, handleSubmit, values, isSubmitting }) => (
                    <Form className='formCategoria' onSubmit={handleSubmit}>
                        ...
                        <input required pattern="[A-Za-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$" className='inpNombre' type="email" name='correo' placeholder='Escriba su Correo electrónico'
                        ...
                        <label>Nombre</label>
                        <input required pattern="[A-Za-z]{1,15}" className='inpNombre' type="text" name='nombre' placeholder='Escriba su Nombre'
                            onChange={handleChange} value={values.nombre} />
                        <label>Apellido</label>
                        <input required pattern="[A-Za-z]{1,15}" className='inpNombre' type="text" name='apellido' placeholder='Escriba su Apellido'
                        ...
                        <input required pattern="[0-9]{1,30}" className='inpNombre' type="tel" name='telefono' placeholder='Escriba su Teléfono'
                            onChange={handleChange} value={values.telefono} />
                        <label>Direccion</label>
                        <input required pattern="[A-Za-z0-9]{1,50}" className='inpNombre' type="text" name='direccion' placeholder='Escriba su Dirección'
